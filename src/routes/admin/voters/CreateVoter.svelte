    ...
    <Drawer.Root bind:open={showMobileDialog} >
        ...
        <Drawer.Content>
            ...
            <Drawer.Header class="text-left">
                ...
                <Drawer.Description>This will create a voter account that will automatically join your voting chamber.</Drawer.Description>
            </Drawer.Header>

            <form method="POST" action="?/createCandidate" enctype="multipart/form-data" use:enhance={createVoterNews} class="">

                <div class="flex flex-col gap-4 p-4">
                    <Label for="username">Username:</Label>
                    <Input name="username" type="text" id="username" class="border-slate-400 dark:border-slate-700" placeholder=""/>
                    
                    <Label for="email">Email:</Label>
                    <Input name="email" type="text" id="email" class="border-slate-400 dark:border-slate-700" placeholder=""/>

                    <Label for="password">Password:</Label>
                    <Input name="password" type="text" id="password" class="border-slate-400 dark:border-slate-700" placeholder=""/>

                    <Label for="confirmPass">Confirm Password:</Label>
                    <Input name="confirmPass" type="text" id="confirmPass" class="border-slate-400 dark:border-slate-700" placeholder=""/>
                </div>
